...
import com.example.SpotifyApi.entities.LableEntity;
import com.example.SpotifyApi.servise.LableService;
...
public class LabelController {
	...
	@PostMapping
	public ResponseEntity <LableEntity> addArtist(@RequestBody LableEntity lable){
		
		//int id = lableService.wait();
		return new ResponseEntity<>( lable, HttpStatus.CREATED);
	}	
	@PutMapping
